    ...
    <div>
      ...
      <form className="flex flex-col sm:flex-row" onSubmit={subscribe}>
        ...
        <div className="mt-2 flex w-full rounded-md shadow-sm sm:mt-0 sm:ml-3">
          <button
            className={`w-full rounded-md border border-gray-200 bg-white py-2 px-4 font-semibold text-primary-500 transition-all ease-in-out dark:border-gray-700 dark:bg-black dark:text-primary-400 dark:hover:text-primary-300 sm:py-0 ${
              subscribed
                ? 'cursor-default'
